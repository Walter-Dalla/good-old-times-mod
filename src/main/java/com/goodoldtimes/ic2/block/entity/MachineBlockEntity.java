...
public class MachineBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    public static String BLOCK_ID = "machine_block_entity";
    ...
    public MachineBlockEntity(BlockPos pos, BlockState state, BlockEntityType<?> entity, String blockId) {
        ...
        this.propertyDelegate = new PropertyDelegate() {
            public int get(int index) {
                return switch (index) {
                    case PROGRESS_INDEX_PROPERTY_DELEGATE -> MachineBlockEntity.this.progress_nbt;
                    case MAX_PROGRESS_INDEX_PROPERTY_DELEGATE -> MachineBlockEntity.this.maxProgress;
                    case ENERGY_INDEX_PROPERTY_DELEGATE -> MachineBlockEntity.this.energy_nbt;
                    case MAX_ENERGY_INDEX_PROPERTY_DELEGATE -> MachineBlockEntity.this.maxEnergy;
            ...
            public void set(int index, int value) {
                switch (index) {
                    case PROGRESS_INDEX_PROPERTY_DELEGATE:
                        MachineBlockEntity.this.progress_nbt = value;
                        break;
                    case MAX_PROGRESS_INDEX_PROPERTY_DELEGATE:
                        MachineBlockEntity.this.maxProgress = value;
                        break;
                    case ENERGY_INDEX_PROPERTY_DELEGATE:
                        MachineBlockEntity.this.energy_nbt = value;
                        break;
                    case MAX_ENERGY_INDEX_PROPERTY_DELEGATE:
                        MachineBlockEntity.this.maxEnergy = value;
                        break;
                    default:
    ...
    private static void addFuel(MachineBlockEntity entity){
    ...
    private static boolean hasNewFuel(MachineBlockEntity entity){
